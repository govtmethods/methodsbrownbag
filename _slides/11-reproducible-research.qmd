...
::: {.column width="64%"}
::: {.incremental}
- Some [setup](../setup.html) for today — a
  GitHub account, git installed
- Who here has watched *Interstellar*?
- Pick out a favourite picture of yourself — you will want it for your website
  at the end
:::
:::
...
::: {.column width="36%"}
::: {.gm-qr}
![](images/qr-setup.svg){.nostretch width="70%" fig-align="center"}

Scan for the setup steps
:::
:::
::::
